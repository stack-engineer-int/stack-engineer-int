...
- Foreign keys to users and organizations`,
		...
		files: [
			...
			{
				filename: "drizzle/0016_create_audit_logs.sql",
				status: "added",
				additions: 25,
				deletions: 0,
			},
...
Migration is reversible - data preserved in both locations until confirmed.`,
		...
		files: [
			...
			{
				filename: "drizzle/0017_create_preferences.sql",
				status: "added",
				additions: 15,
				deletions: 0,
			},
			{
				filename: "drizzle/0018_backfill_preferences.sql",
				status: "added",
				additions: 25,
				deletions: 0,
			},
			{
				filename: "src/lib/server/preferences.ts",
				status: "modified",
				additions: 35,
				deletions: 42,
			},
